...
<nav class="navbar navbar-expand-md navbar-light bg-light">
	...
	<div class = "collapse navbar-collapse">
		<ul class = 'navbar-nav mr-auto'>
			<li class = "nav-item dropdown">
				...
				<div class = "dropdown-menu" aria-labelledby="navbarDropdown">
					<a class = "dropdown-item" href="EditVenue.jsp">Edit Venue</a>
					<a class = "dropdown-item" href="ViewVenue.jsp">View Venue</a>
				</div>
			</li>
			<li class = "nav-item dropdown">
				<a class="nav-link dropdown-toggle"href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				...
				<div class = "dropdown-menu" aria-labelledby="navbarDropdown">
					<a class = "dropdown-item" href="EditConcert.jsp">Edit Concert</a>
				</div>
			</li>
			<li class = "nav-item">
		...
		<form class = "form-inline">
			<input class="form-control mr-sm-2" type="search" placeholder="Search Concert" aria-label="Search">
    		<a class="btn btn-outline-info my-2 my-sm-0" type="submit" href="ConcertSearchResults.jsp">Search</a>
		</form>
	</div>
</nav>
<!-- Carousel Bootstrap -->
