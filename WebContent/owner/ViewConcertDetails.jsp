...
<title>Concert Results Details</title>
</head>
<body>
		...
		<ul class = 'navbar-nav mr-auto'>
			...
			<li class = "nav-item dropdown">
				...
				<div class = "dropdown-menu" aria-labelledby="navbarDropdown">
					<a class = "dropdown-item" href="AddConcert.jsp">Add Concert</a>
				</div>
			</li>
			<li class = "nav-item">
...
<div class="container-fluid">
	...
	<div class = "row">
		<div class ="col-md-12">
			<h4>Band Name: null</h4>
			<h4>Band Media: null</h4>
			<h4>Band and Concert Description: null</h4>
			<h4>Band Acts: null</h4>
			<h4>Concert Start Time: null</h4>
		</div>
	</div>
</div>
<div class = "container-fluid">
	<div class = "row">
		<div class = "col-md-12">
			<form id="concertDetailForm">
				<div class = "form-group">
					<label for="newBandName">Headliner/Band Name</label>
					<input type = "text" class = "form-control" placeholder="Enter Headliner/Band Name" >
				</div>
				<div class = "form-group">
				...
				<div class = "form-group">
					<label for="newActs">Any Other Opening acts/bands</label>
					<input type = "text" class = "form-control" placeholder="Enter other opening acts or bands" >
				</div>
				<div class = "form-group">
			...
			<button form="concertDetailsForm" type="submit" class="btn btn-primary">Update</button>
